...
five_thirty_eight_2 = 
 left_join(five_thirty_eight_1, unemployment, by = "year")

## Pols_month dataset:after combing the president variable, it had 9 variables - year, president, repupblican and democratic governors/senators/and represenatives. 4 variables once modified - year, day, month, and close. The prez_gop variable, which should only have values 0 and 1 has some values of 2 - unclear why that it. 
## SNP dataset: has 4 variables - month, year, day, and S&P closing values of that day. 
## unemployment dataset: has 13 variables (year and each month). the values correspond to the unemployment rate during that time.
